...
>
    <div class="site-container">
            <div class="testimonials-carousel swiper" <?php if (count($testimonials) > 1) : ?>data-swiper-type="testimonials"<?php endif; ?>>
                <div class="swiper-wrapper">
                    <?php foreach ($testimonials as $testimonial) : 
                        ...
                        $flipped = get_field('flipped', $testimonial);
                    ?>
                        <div class="testimonial swiper-slide <?php if ($flipped) : ?>flipped<?php endif; ?>">
            ...
            <?php get_template_part('template-parts/components/swiper-pag', 
                false, 
                array('pagination_colour' => 'white')
            ); ?>
    </div>
</section>