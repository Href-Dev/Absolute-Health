    ...
    <div class="site-container">
        ...
        <?php if ($stats) : ?>
            <div class="carousel-container" data-animate>
                <div class="stats-carousel swiper" data-swiper-type='stats-carousel'>
                    <div class="swiper-wrapper">
                        <?php foreach ($stats as $stat) : ?>
                            <div class="swiper-slide single-el-container">
                                <?php echo get_template_part(
                                    'template-parts/components/single-stat',
                                    null,
                                    $stat
                                ); ?>
                            </div>
                ...
                <?php echo get_template_part('template-parts/components/swiper-nav', false, array('nav_colour' => null)); ?>
